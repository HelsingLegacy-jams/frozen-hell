...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Survivor.Movement.Speed speed { get { return (Code.Gameplay.Features.Survivor.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Survivor.Movement.Speed)CreateComponent(index, typeof(Code.Gameplay.Features.Survivor.Movement.Speed));
