...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.Survivor.Movement.MovementAvailable movementAvailableComponent = new Code.Gameplay.Features.Survivor.Movement.MovementAvailable();
